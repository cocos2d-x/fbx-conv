...
LOG_SET_MSG(eCommandLineInvalidVertexWeight,
            "Maximum vertex weights must be between 0 and 8")
LOG_SET_MSG(eCommandLineInvalidBoneCount,
            "Maximum bones per nodepart must be greater or equal to the "
            "maximum vertex weights")
LOG_SET_MSG(eCommandLineInvalidVertexCount,
            "Maximum vertex count must be between 0 and 32k")
...
LOG_SET_MSG(wSourceLoadFbxNodeRrSs,
            "[%s] Node uses RrSs mode, transformation might be incorrect")
...
LOG_SET_MSG(iSourceConvertFbxMeshInfo,
            "[%s] polygons: %d (%d indices), control points: %d")
LOG_SET_MSG(
    wSourceConvertFbxDuplicateNodeId,
    "[%s] Duplicate node id, skipping the node and all it's child nodes")
LOG_SET_MSG(wSourceConvertFbxInvalidBone, "[%s] Skipping invalid bone: %s")
LOG_SET_MSG(wSourceConvertFbxAdditiveBones,
            "[%s] Additive bones not supported (yet)")
LOG_SET_MSG(wSourceConvertFbxCantTriangulate,
            "[%s] Skipping geometry, because it can't be triangulated")
LOG_SET_MSG(wSourceConvertFbxExceedsIndices,
            "Mesh contains more indices (%d) than the specified maximum (%d)")
LOG_SET_MSG(
    wSourceConvertFbxExceedsBones,
    "Mesh contains more blendweights per polygon than the specified maximum.")
LOG_SET_MSG(wSourceConvertFbxZeroWeights,
            "Mesh contains vertices with zero bone weights.")
LOG_SET_MSG(wSourceConvertFbxDuplicateMesh,
            "[%s] Skipping geometry with duplicate mesh")
LOG_SET_MSG(wSourceConvertFbxNoMaterial,
            "[%s] Skipping geometry without material")
LOG_SET_MSG(wSourceConvertFbxEmptyMeshpart,
            "[%s] Skipping empty node part, material: '%s'")
LOG_SET_MSG(wSourceConvertFbxMaterialUnknown,
            "[%s] Material doesn\'t extend FbxSurfaceLambert, replaced with "
            "RED diffuse")
LOG_SET_MSG(
    wSourceConvertFbxMaterialHLSL,
    "[%s] Material HLSL shading not supported, replaced with RED diffuse")
LOG_SET_MSG(
    wSourceConvertFbxMaterialCgFX,
    "[%s] Material CgFX shading not supported, replaced with RED diffuse")
LOG_SET_MSG(
    wSourceConvertFbxPolyMaterialInvalid,
    "[%s] Skipping vertices without material,please check the material ID")
...
LOG_SET_MSG(sExportToG3DB, "Exporting to c3b file: %s")
...
LOG_SET_MSG(iModelInfoMeshesSummary,
            "Meshes    : %d (%d vertices, %d parts, %d indices)")
