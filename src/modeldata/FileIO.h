...
/**
 * Writes the length of the string and the string bytes to the binary file
 * stream.
 */
...
/**
 * Skips over the string at the current file stream offset by moving the file
 * position. Assumes the current position points to the unsigned int length of
 * the string. The string is assumed to be a char array.
 *
